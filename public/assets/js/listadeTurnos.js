...
$(function () {
  ...
  var dt_user_table = $('.datatables-listaDeTurnos'),
    select2 = $('.select2'),
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
     ajax: {
        "method":"POST",
        "url": "../../funcionalidadesphp/GUIA/listadeTurnos.php"
      },
      columns: [
        { data: "id_guiaTurnos" },
        { data: "guia_codigo" },
      ...
      columnDefs: [
        
        {
          ...
          render: function (data, type, full, meta) {
            var $nombreddd = full['id_guiaTurnos'];

            if($nombreddd != ""){
              return '<span class="fw-semibold">' + $nombreddd'</span>';
            }else{
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Details of ' + data['guia_codigo'];
            }
          }),
          type: 'column',
