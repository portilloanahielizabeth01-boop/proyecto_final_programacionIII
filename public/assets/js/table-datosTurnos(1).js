...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
     ajax: {
        "method":"POST",
        "url": "../../funcionalidadesphp/GUIA/listadeTurnos02.php"
      },
      columns: [
        { data: "fechaInicio" },
        { data: "usuariosNombre" },
      ...
      columnDefs: [
        
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if($fecha_de_inicio != ""){
              return '<span class="fw-semibold">' + $fecha_de_inicio + '</span>';
            }else{
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
           ...
           var  $usuarios_apellido=  full['guiaTurnos_fecha_de_inicio'];

            if($usuarios_nombre != ""){
              return '<span class="fw-semibold">' + $usuarios_nombre + '   ' +     $usuarios_apellido + '</span>';
            }else{
              return '<span class="fw-semibold"> - </span>';
            }
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $usuarios_dni = full['guiaTurnos_fecha_de_cierre'];
        ...
        },
        {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var $gde_detalles= full['guia_nro_telefono'];
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $Rela_estado= full['guia_dnicliente'];
            var  $cantidad_dias = full['guia_detalles'];
            console.log($cantidad_dias);

            if($Rela_estado != ""){
            if($Rela_estado=="pendiente"){
              return '<span class="badge bg-label-warning me-1">' + $Rela_estado + '</span>';
            }else{
              return '<span class="badge bg-label-info me-1">' + $Rela_estado + '</span>';
            }
          }else{
            return '<span class="fw-semibold"> - </span>';
          }
        ...
        },
        {
          ...
          targets: 5,
          render: function (data, type, full, meta) {
            var $rela_estado= full['rela_equipo'];

            if($rela_estado != ""){
              return '<span class="fw-semibold">' + $rela_estado + '</span>';
            }else{
              return '<span class="fw-semibold"> - </span>';
            }
