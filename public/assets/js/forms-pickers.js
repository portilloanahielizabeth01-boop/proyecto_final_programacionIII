...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
    flatpickrTime = document.querySelector('#flatpickr-time01'),
    flatpickrTime01 = document.querySelector('#flatpickr-time'),
    HorarioInicio = document.querySelector('#HorarioInicio'),
    HorarioFin = document.querySelector('#HorarioFin'),
