      ...
      fields: {
        ...
        nombrecurso: {
          validators: {
            ...
            regexp: {
              regexp: /^[a-zA-Z0-9 ]+$/,
              message: 'El nombre del curso debe estar compuesto sólo de letras, números y espacios'
            }
          }
        },
        DescripcionCurso: {
        ...
        FechaInicio: {
          validators: {
            ...
            stringLength: {
              min: 6,
              max: 30,
              message: 'La Fecha de inicio del curso necesita más de 6 caracteres'
            },
        ...
        FechaFin: {
          validators: {
            ...
            stringLength: {
              min: 6,
              max: 30,
              message: 'La fecha de fin del curso necesita más de 6 caracteres'
            },
