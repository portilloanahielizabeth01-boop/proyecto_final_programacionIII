  ...
  if (dt_user_table.length) {
   ...
   //  var $fecha_de_inicio = full['guia_detalles'];
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $EquipoS= full['EquipoDescripcion'];

            if($EquipoS !== "" && $EquipoS !== null){
              return '<span class="fw-semibold">' + $EquipoS + '</span>';
            }else{
              return '<span class="fw-semibold"> - </span>';
            }
        ...
        },
        {
          ...
          targets: 6,
          render: function (data, type, full, meta) {
            var $TurnoDescri= full['guia_tipoTurnoDescripcion'];
           
           
        
            if($TurnoDescri != ""){
              return '<span class="fw-semibold">' + $TurnoDescri + '</span>';
            }else{
              return '<span class="fw-semibold"> - </span>';
            }
