...
$(function () {
  ...
  var dt_user_table = $('.datatables-listaTurnos'),
    select2 = $('.select2'),
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      columns: [
        ...
        { data: 'idguiaTurnos' },
        { data: 'guiacodigo' },
        { data: 'guiaTurnos_fechainicio' },
        { data: 'guiaTurnosfechacierre' },
        { data: 'gg' },
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            var $fecha_de_inicio = full['id_guiaTurnos'];
        ...
        },
        {
          ...
          targets: 1,
          render: function (data, type, full, meta) {
            let a = full['guia_codigo'];
             console.log(a);
            if($a != ""){
              return '<span class="fw-semibold">' + $a + '$</span>';
            }else{
              return '<span class="fw-semibold"> Sin Precio de Compra</span>';
            }
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $b = full['guiaTurnos_fecha_de_inicio'];

            if($b != ""){
              return '<span class="fw-semibold">' + $b + '$</span>';
            }else{
              return '<span class="fw-semibold"> Sin Precio de Compra</span>';
            }
        ...
        },
        {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var $c = full['guiaTurnos_fecha_de_cierre'];

            return '<span class="fw-semibold">' + $c + '$</span>';
          }
        },
        {
          // User Status
          targets: 4,
          render: function (data, type, full, meta) {
            var $stockAmount = full['guia_nro_telefono'];
...

        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<button class="btn btn-sm btn-icon" data-bs-toggle="modal" data-bs-target="#largeModal"><i class="bx bx-edit"></i></button>' +
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Details of ' + data['id_guiaTurnos'];
            }
          }),
          type: 'column',
